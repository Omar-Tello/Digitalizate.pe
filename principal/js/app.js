(function () {
  ...
  var I18N = {
    en: {
      ...
      'hero.title': 'Tecnologia para negocios que crecen',
      'hero.sub':
      ...
      'sec.grid.sub': 'Explora nuestras areas principales: software, hardware con soporte digital, capacitaciones, comunidad y diseno grafico.',
      ...
      'card.chamfer.text': 'Equipos, componentes y soluciones fisicas para que tu infraestructura trabaje sin friccion. Ademas, soporte digital y acompanamiento para mejorar, mantener y escalar tus herramientas digitales.',
      'card.brutal.title': 'Capacitaciones',
      'card.brutal.text': 'Talleres practicos para aprender herramientas digitales con proyectos reales.',
      'card.cinema.title': 'Unete a nosotros',
      'card.cinema.text': 'Forma parte de una comunidad que crea y entrega tecnologia con impacto real.',
      'card.facet.title': 'Diseno grafico',
      ...
      'card.stack.text': 'Equipos, componentes, soporte digital y acompanamiento para mantener tus herramientas digitales.',
      'cta.more': 'Consultar',
      ...
      'carousel.3t': 'Capacitacion',
      'carousel.3d': 'Aprendizaje practico para equipos, emprendedores y estudiantes.',
      'carousel.4t': 'Diseno',
      'carousel.4d': 'Piezas graficas e identidad visual para vender con claridad.',
